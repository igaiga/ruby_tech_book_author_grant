...
提出済みのPRは期限まで自由に修正することができます。

内容を非公開で提出したい方は、「メールアドレスで提出」の旨を書いたPRを送ったのち、kuniaki.igarashi(at)garnettech373.com宛にメールしてください。非公開のプロジェクトが採択された場合は、内容の公開時期をご相談させていただきます。
